...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "ScreenshotsMCPCore",
            dependencies: [.product(name: "MCP", package: "swift-sdk")]
        ),
        .executableTarget(
            name: "apple-screenshots-mcp",
            dependencies: ["ScreenshotsMCPCore"],
            ...
            // embedded plist macOS denies photo library access without ever prompting.
            linkerSettings: [
                .unsafeFlags([
                    "-Xlinker", "-sectcreate",
                    "-Xlinker", "__TEXT",
        ...
        .testTarget(name: "ScreenshotsMCPCoreTests", dependencies: ["ScreenshotsMCPCore"]),
    ]
)
